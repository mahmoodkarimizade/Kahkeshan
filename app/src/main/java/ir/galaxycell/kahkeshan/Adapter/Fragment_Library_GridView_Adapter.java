 ...
 */
public class Fragment_Library_GridView_Adapter extends BaseAdapter
{
    ...
    public Fragment_Library_GridView_Adapter(Context context,List<ResOtherLoadMoreLibrary>list)
    {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup)
    {
        ...
        image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                FragmentLibrary fragmentLibrary=(FragmentLibrary) ((FragmentActivity) MainActivity.context).getSupportFragmentManager().findFragmentById(R.id.main_framlayout_fragmentitemselected2);
                fragmentLibrary.sendDataToSeeEditProduct(list.get(i));
            }
        });
