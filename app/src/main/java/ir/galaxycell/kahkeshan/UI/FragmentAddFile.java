...
public class FragmentAddFile extends Fragment {
    ...
    {
        //Image View
        productfile=(ImageView)view.findViewById(R.id.fragment_add_file_imageview_productfile);

        //Text View
        titleFile=(TextView)view.findViewById(R.id.fragment_add_file_textview_titlefile);
        addressFile=(TextView)view.findViewById(R.id.fragment_add_file_textview_addressfile);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(resultCode== getActivity().RESULT_OK && data!=null)
        {
            ...
            {
                FragmentAdd.filepath=docPaths.get(0);
